...
var CompressionPlugin = function () {
  function CompressionPlugin() {
    ...
    var _options$asset = options.asset,
        ...
        _options$useOriginalN = options.useOriginalName,
        useOriginalName = _options$useOriginalN === undefined ? false : _options$useOriginalN;
    ...
    value: function apply(compiler) {
      ...
      compiler.plugin('emit', function (compilation, callback) {
        var _options = _this.options,
            ...
            useOriginalName = _options.useOriginalName;
        ...
        _async2.default.forEach(Object.keys(assets), function (file, cb) {
          ...
          return Promise.resolve().then(function () {
            ...
            if (useOriginalName) {
              assets[file] = new _RawSource2.default(result);
            } else {
